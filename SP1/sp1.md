...
<img width="886" height="576" alt="image" src="https://github.com/user-attachments/assets/4e4da1ac-73d1-4e43-84ae-cd2c6774626e" />

## Pas 2 - Assignar recursos (RAM mínima 4 GB, disc mínim 40 GB)
<img width="884" height="618" alt="image" src="https://github.com/user-attachments/assets/e886052a-d5d9-4397-bbfb-357d8db36f36" />

<img width="877" height="583" alt="image" src="https://github.com/user-attachments/assets/0261abd3-4bec-4f25-b4fd-3f033e31fe9a" />

## Pas 3 - Carregar la ISO de Windows 11

<img width="888" height="618" alt="image" src="https://github.com/user-attachments/assets/c4205f6f-dc46-4e30-9630-22c49af58024" />

## Pas 4 - Instal·lar el sistema (idioma, usuari, contrasenya)

<img width="880" height="620" alt="image" src="https://github.com/user-attachments/assets/1260b799-c5ff-4070-88e2-b6fa05dcb422" />

<img width="1025" height="800" alt="image" src="https://github.com/user-attachments/assets/70b80375-fb3e-465d-9a27-31648a61fee6" />

## 05. Verificació de la posada en marxa
És fonamental assegurar-se que el sistema s'inicia sense incidències. Comprova que tots els processos arrenquen correctament abans de continuar.

<img width="1016" height="838" alt="image" src="https://github.com/user-attachments/assets/b13a3882-0a61-4550-8953-5b40c4248ae0" />

<img width="1025" height="867" alt="image" src="https://github.com/user-attachments/assets/efabe234-154e-41fc-9bad-a069f4a7fdc1" />

# Fase 2 - Configuració de la restauració

## 6. Accedir a la funció “Crear un punt de restauració”

<img width="752" height="588" alt="image" src="https://github.com/user-attachments/assets/16a4db77-c803-4c21-ac97-6d33362ed96c" />

## Pas 7 – Habilitar la salvaguarda del sistema a la unitat C:

<img width="1026" height="726" alt="image" src="https://github.com/user-attachments/assets/c03f1954-af9c-48d1-847c-09076182204f" />

## Pas 8 – Generar un punt de retorn de forma manual

<img width="1027" height="724" alt="image" src="https://github.com/user-attachments/assets/8d9cd8ec-1592-48c7-a121-7f476b34d692" />

<img width="324" height="148" alt="image" src="https://github.com/user-attachments/assets/cbf38710-6468-47f1-89d1-bc432a58fdd4" />

<img width="351" height="127" alt="image" src="https://github.com/user-attachments/assets/bb0eeda2-bd88-41e8-aecd-c488d801a996" />

## Pas 9 - Fer un canvi (instal·lar app o configuració)

<img width="585" height="151" alt="image" src="https://github.com/user-attachments/assets/2f867fc1-b736-4eda-b572-dcf59159a821" />

<img width="1025" height="724" alt="image" src="https://github.com/user-attachments/assets/dc24a320-0ec9-403d-a157-b83fed7eb7d0" />

## Pas 10 – Execució de la restauració i validació final

<img width="411" height="256" alt="image" src="https://github.com/user-attachments/assets/861a8565-fdd4-4de3-adc8-8b10107c71f5" />

<img width="564" height="461" alt="image" src="https://github.com/user-attachments/assets/50a15ab7-2062-4903-b75c-8856e514dc16" />

<img width="566" height="459" alt="image" src="https://github.com/user-attachments/assets/d3270da7-21a2-41e5-a3d4-2573e85b40d3" />

<img width="522" height="200" alt="image" src="https://github.com/user-attachments/assets/7564f832-e57f-4396-9c85-84ec8ad10318" />

<img width="1029" height="773" alt="image" src="https://github.com/user-attachments/assets/d754fd39-763f-4ddd-a3ba-029062ce84c0" />

<img width="400" height="150" alt="image" src="https://github.com/user-attachments/assets/adcedb0a-5e26-429b-88bc-49c62009874b" />

<img width="1025" height="719" alt="image" src="https://github.com/user-attachments/assets/772d5276-6134-489f-a50c-9ef4491e8f5d" />

# Fase 3: Validació del sistema operatiu

## Pas 11. Accedir al panell de "Activació" dins de la configuració del sistema

<img width="799" height="631" alt="image" src="https://github.com/user-attachments/assets/338e0ef7-3791-4c1a-8fc9-55dd6273d9bd" />

## Pas 12 – Validar l'activació correcte del sistema

<img width="656" height="638" alt="image" src="https://github.com/user-attachments/assets/6ba302cc-4329-4f2a-bc72-dc724cd6cbc8" />

## Pas 13 – Consultar l'expiració de la llicència mitjançant l'ordre: `slmgr /xpr`

<img width="960" height="511" alt="image" src="https://github.com/user-attachments/assets/ded74614-3a8c-4a12-9c4d-0a2dba06213a" />

## Pas 14 – Identificar el tipus de llicència i redactar-ne una breu síntesi

| Modalitat de Llicència | Característiques Principals |
| :--- | :--- |
| **Retail (FPP)** | Versió de venda al públic que s'associa a la persona. Es pot transferir entre diferents equips. |
| **OEM** | Programari integrat pel fabricant de l'ordinador. La llicència mor amb el maquinari original. |
| **Per Volum** | Solució per a entitats i organitzacions que necessiten una gestió massiva d'activacions. |
| **Digital** | Mètode d'activació modern que enllaça el dret d'ús amb el perfil de Microsoft i la ID del PC. |
| **Per Subscripció** | Model de lloguer per ús (com *Windows 365*), basat en pagaments periòdics i serveis al núvol. |

## Pas 15 – Recerca de costos estimats per a llicències de Windows

| Variant del sistema | Preu Oficial (Microsoft Store) | Distribuïdors i mercat alternatiu* |
| :--- | :--- | :--- |
| **Windows 11 Home** | Aprox. 145 € | Entre 10 € i 20 € |
| **Windows 11 Pro** | Aprox. 259 € | Entre 15 € i 30 € |

> **Apunt rellevant sobre preus baixos:** Les claus econòmiques (10-30 €) que es troben a la xarxa solen ser de tipus OEM. Tot i que la legislació europea permet la seva revenda, cal tenir en compte que s'associen definitivament al maquinari de l'equip i no disposen d'assistència tècnica oficial per part de Microsoft.

---

# Fase 4 – Administració de l'arrencada

## Pas 16 – Executar el Símbol del sistema amb privilegis d'administrador

<img width="753" height="642" alt="image" src="https://github.com/user-attachments/assets/a8700ddc-ff02-41a0-8ae9-f0477a99e2a8" />

## Pas 17 – Llançar la comanda `bcdedit` per visualitzar la configuració d'arrencada

<img width="605" height="571" alt="image" src="https://github.com/user-attachments/assets/9b6753d4-c0ab-44eb-967c-a92e87c30577" />

## Pas 18 – Diferenciar les seccions del BCD

### Gestor d'arrencada de Windows (Windows Boot Manager)

<img width="570" height="204" alt="image" src="https://github.com/user-attachments/assets/bf54690b-a984-482d-afb4-98327dd33819" />

### Cargador de arranque de Windows (Boot Loader)

<img width="531" height="316" alt="image" src="https://github.com/user-attachments/assets/e2af9311-e162-4608-b2b0-44d1253f21b7" />

## Pas 19 – Anàlisi dels paràmetres detallats

### Gestor de l'arrencada (Boot Manager)

* **`default`**: `{current}` ➔ Indica quina és la plataforma que s'iniciarà de manera predeterminada.
* **`timeout`**: `30` ➔ Defineix el marge de temps (en segons) de què disposa l'usuari abans de l'inici automàtic.

### Carregador de l'arrencada (Boot Loader)

* **`device`**: `partition=C:` ➔ Especifica el volum o partició on s'allotja el sistema operatiu.
* **`path`**: `\WINDOWS\system32\winload.efi` ➔ Ruta del fitxer binari encarregat de la càrrega del sistema.
* **`description`**: `Windows 11` ➔ Etiqueta identificativa de la versió instal·lada.

## Pas 20 – Resolució de qüestions tècniques

* **Quin sistema s'està executant actualment?**
  Es tracta de **Windows 11**, tal com es detalla a la línia `description` de la secció del carregador.

* **On resideix la instal·lació del sistema?**
  Es troba a la **unitat C:**, dada que es pot verificar mitjançant el paràmetre `device`.

* **Quin és l'interval d'espera configurat?**
  El sistema roman a l'espera durant **30 segons** abans de continuar, segons marca el valor `timeout`.

* **Quin fitxer és el responsable d'iniciar Windows?**
  La càrrega depèn de l'executable **`winload.efi`**, situat a la ruta definida al paràmetre `path`.

## Pas 21 – Conclusió sobre els components d'inici

* **Funció del Boot Manager (Gestor):** Actua com el director de l'orquestra; llegeix el fitxer de configuració i gestiona el menú d'opcions inicials i els temps de resposta.
* **Funció del Boot Loader (Carregador):** És l'executant que, un cop rep el permís del gestor, trasllada el kernel de Windows des de l'emmagatzematge fins a la memòria RAM per posar-lo en marxa.

---

# Fase 5 – Connectivitat i Xarxa

## Pas 22 – Accedir al panell de configuració de xarxa

<img width="1027" height="771" alt="image" src="https://github.com/user-attachments/assets/14c3c429-ab94-494d-92f3-c20568dc02ac" />

<img width="1027" height="767" alt="image" src="https://github.com/user-attachments/assets/3fb128d0-345e-496e-950f-963ff87affce" />

## Pas 23 – Obtenció de l'adreça IP mitjançant l'ordre: `ipconfig`

<img width="961" height="511" alt="image" src="https://github.com/user-attachments/assets/51bcd5d5-ebf0-460d-8be6-fec3111041ca" />

## Pas 24 – Establir l'assignació d'IP automàtica mitjançant DHCP

<img width="386" height="189" alt="image" src="https://github.com/user-attachments/assets/d94f95f6-7c91-43ec-8764-d8f461b47c26" />

<img width="474" height="165" alt="image" src="https://github.com/user-attachments/assets/a7e57794-ad7a-448b-92dc-4247482c4a53" />

## Pas 25 – Assignació manual d'una IP estàtica i paràmetres de xarxa
En aquest apartat, definirem manualment l'adreça IP, la màscara de subxarxa, la porta d'enllaç i els servidors DNS.

<img width="392" height="358" alt="image" src="https://github.com/user-attachments/assets/0b9fbd62-45e3-4b04-9f5b-cca16812a405" />

<img width="390" height="715" alt="image" src="https://github.com/user-attachments/assets/7db9405e-065e-403e-9f16-08fdd3a86125" />

<img width="425" height="423" alt="image" src="https://github.com/user-attachments/assets/b9388acb-e354-4d60-be2d-33666b01ee80" />

## Pas 26 – Verificar la connectivitat externa realitzant un `ping` a google.com

<img width="527" height="261" alt="image" src="https://github.com/user-attachments/assets/a0fdd9d8-87f0-4722-943d-ccd555283707" />

# Fase 6 - Execució de comandes generals

## 27. Accedir a l'entorn de PowerShell
